...
namespace AxisBank.lib.Core
{
    public class AuthRepository
    {
        ...
        public static void setDashBoard(string email)
        {
            ...
            Costumers loggedIncostumer = new Costumers(costumerDit.Split(",")[0], costumerDit.Split(",")[0], costumerDit.Split(",")[0], costumerDit.Split(",")[0], costumerDit.Split(",")[0], costumerDit.Split(",")[0]) ;
