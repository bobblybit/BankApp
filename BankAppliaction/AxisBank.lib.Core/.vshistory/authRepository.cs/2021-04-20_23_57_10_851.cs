...
namespace AxisBank.lib.Core
{
    public class AuthRepository
    {
        ...
        public static Costumers setDashBoard(string email)
        {
            string costumerDit = CostumerRepository.getCostumerByEmail(email);

            Costumers loggedIncostumer = new Costumers(costumerDit.Split(",")[0], costumerDit.Split(",")[1], costumerDit.Split(",")[2], costumerDit.Split(",")[3], costumerDit.Split(",")[4], costumerDit.Split(",")[5]) ;
