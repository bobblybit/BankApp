...
namespace AxisBank.lib.Core
{
    public static class AccountRepository
    {
        ...
        public static bool createNewAccount(string costid ,string initamount , string acctype)
        {
            ...
            data.Add (newAccount.accountID+","+costid+","+newAccount.firstName+","+newAccount.lastName+","+accnum+","+acctype+","+newAccount.dateOfOpening +","+newAccount.accountBalance);
            ...
            string remark = "Account Openeing";
            TransactionRepository.initialDeposit(costid ,sender, reciever, initamount, type, openeingBalance, closinBalance, );
            return true;
        }
    }
}
