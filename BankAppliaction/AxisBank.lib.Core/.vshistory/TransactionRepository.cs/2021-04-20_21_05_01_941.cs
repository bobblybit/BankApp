...
namespace AxisBank.lib.Core
{
    public class TransactionRepository
    {
...

        {
            ...
            data.Add(initdeposit.transactionID+","+ initdeposit.costumerId + "," + sender + "," + reciever + "," + initamount + "," + type +","+ openeingBalance+ ","+ closinBalance +","+ remark);
        ...
        public static bool depositToAccount(string accNumber, string amount)
        {
